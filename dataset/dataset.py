...
class weather_dataset(Dataset):
    def __init__(self, data_dir='data/era5_np128x256', split='train', **kwargs) -> None:
        super().__init__()
        # print("init begin")
        ...
        # if self.length > 6:
        #     self.compound_data_queue_num = 1
        # else:
    ...
    def _get_meanstd(self):
        ...
        with open(os.path.join(stats_dir, 'mean_std.json'), mode='r') as f:
            multi_level_mean_std = json.load(f)
        with open(os.path.join(stats_dir, 'mean_std_single.json'), mode='r') as f:
